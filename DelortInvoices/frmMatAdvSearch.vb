...
Public Class frmMatAdvSearch

    Inherits frmBaseWindow

#Region " Modular-level Variables "

    Private WithEvents m_AdvSrch As New MatAdvSearch(g_settings)
    Private m_Materials As New DelortBusObjects.Materials(g_settings)
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmMatAdvSearch))
        ...
        Me.grpDates.Location = New System.Drawing.Point(170, 8)
        Me.grpDates.Name = "grpDates"
        Me.grpDates.Size = New System.Drawing.Size(190, 72)
        ...
        Me.grpAction.Location = New System.Drawing.Point(171, 141)
        Me.grpAction.Name = "grpAction"
        Me.grpAction.Size = New System.Drawing.Size(189, 80)
        ...
        Me.grpSearchText.Location = New System.Drawing.Point(170, 80)
        Me.grpSearchText.Name = "grpSearchText"
        Me.grpSearchText.Size = New System.Drawing.Size(190, 56)
        ...
        Me.txtSearchData.Size = New System.Drawing.Size(163, 19)
        ...
        Me.grpInvoices.Location = New System.Drawing.Point(8, 226)
        Me.grpInvoices.Name = "grpInvoices"
        Me.grpInvoices.Size = New System.Drawing.Size(352, 330)
        ...
        Me.grdList.Location = New System.Drawing.Point(8, 13)
        Me.grdList.Name = "grdList"
        Me.grdList.Size = New System.Drawing.Size(336, 310)
        ...
        Me.grpCost.Location = New System.Drawing.Point(8, 141)
        ...
        Me.ClientSize = New System.Drawing.Size(366, 561)
        ...
        Me.Name = "frmMatAdvSearch"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Advanced Material Search"
...
#Region " Control Events "
    ...
    Private Sub dtpFromDate_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtpFromDate.ValueChanged, dtpToDate.ValueChanged
        ...
        Try
            With Me.m_AdvSrch
                .FromDate = Convert.ToDateTime(Me.dtpFromDate.Value)
                .ToDate = Convert.ToDateTime(Me.dtpToDate.Value)
            End With
    ...
    Private Sub txtSearchData_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearchData.TextChanged
        ...
        Try
            ...
            m_AdvSrch.SearchText = Me.txtSearchData.Text.Trim
        ...
        Try
            ...
            With Me.m_AdvSrch
                ...
                If Me.rdoDesc.Checked Then
                    .ReportType = MatAdvSearch.SearchType.Desc
                ElseIf Me.rdoNotes.Checked Then
                    .ReportType = MatAdvSearch.SearchType.Notes
                ElseIf Me.rdoPriceRange.Checked Then
                    .ReportType = MatAdvSearch.SearchType.PriceRange
                End If
        ...
        Try
            ...
            With m_AdvSrch
                ...
                If IsNumeric(Me.txtPriceFrom.Text) Then
                    .PriceFrom = Convert.ToDouble(Me.txtPriceFrom.Text)
                Else
                    .PriceFrom = 0
                End If
    ...
    Private Sub txtPriceTo_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPriceTo.TextChanged
        ...
        With Me.m_AdvSrch
            ...
            If IsNumeric(Me.txtPriceTo.Text) Then
                .PriceTo = Convert.ToDouble(Me.txtPriceTo.Text)
            Else
                .PriceTo = 0
            End If
    ...
    Private Sub grdList_InitializeLayout(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs) Handles grdList.InitializeLayout
        ...
        With e.Layout.Bands(0)
            ...
            .Columns(1).Width = 85
            .Columns(2).Header.Caption = "Description"
            .Columns(2).Width = 110

            .Columns(3).Header.Caption = "Cost"
            .Columns(3).Width = 80
            .Columns(3).Format = "c"

            .Columns(4).Header.Caption = "Notes"
            .Columns(4).Width = 110
...
#Region " Event Sinks "
    ...
    Private Sub m_AdvSrch_IsPriceRange(ByVal bolPriceRange As Boolean) Handles m_AdvSrch.IsPriceRange
    ...
    Private Sub m_AdvSrch_ReadyToSearch(ByVal Valid As Boolean) Handles m_AdvSrch.ReadyToSearch

        Me.btnRefresh.Enabled = Valid

    End Sub

    Private Sub m_AdvSrch_CostRangeValid(ByVal bolValid As Boolean) Handles m_AdvSrch.CostRangeValid
    ...
    Private Sub m_AdvSrch_TextChanged() Handles m_AdvSrch.TextChanged
...
#Region " Private Routines "
    ...
    Private Sub OpenItem()
        ...
        If Me.grdList.Rows.VisibleRowCount > 0 Then
            ...
            Dim MatNum As Integer = Convert.ToInt32(Me.grdList.ActiveRow.Cells(0).Value)

            Dim ds As DataSet = m_Materials.GetMaterialItem(MatNum)

            If ds.Tables(0).Rows.Count = 1 Then

                Utilities.ViewEditMaterials(Me.MdiParent, Nothing, ds)
    ...
    Private Sub DeleteItem()
        ...
        If Me.grdList.Rows.VisibleRowCount > 0 Then
            If MessageBox.Show("Are you sure you want to delete this item?", ProgramName, MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = DialogResult.Yes Then
                Dim MatNum As Integer = Convert.ToInt32(Me.grdList.ActiveRow.Cells(0).Value)
                With m_Materials
                    .CrudMode = Materials.DBMode.Delete
                    .MaterialNo = MatNum
                    .InsertUpdateDelete()
                End With
