...
Public Class frmWindowsCustomersReport
    ...
    Private WithEvents CustReport As New WindowCustomerRpt(g_Settings)
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmWindowsCustomersReport))
        ...
        Me.rdoAllCustomers.Size = New System.Drawing.Size(129, 16)
        ...
        Me.grpFirstName.Location = New System.Drawing.Point(209, 52)
        Me.grpFirstName.Name = "grpFirstName"
        Me.grpFirstName.Size = New System.Drawing.Size(106, 40)
        ...
        Me.grpLastName.Location = New System.Drawing.Point(209, 7)
        Me.grpLastName.Name = "grpLastName"
        Me.grpLastName.Size = New System.Drawing.Size(106, 40)
        ...
        Me.rdoLastContains.Location = New System.Drawing.Point(9, 23)
        ...
        Me.Name = "frmWindowsCustomersReport"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Window Customers"
...
#End Region
    ...
    Private Sub rdoAllCustomers_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rdoAllCustomers.CheckedChanged
        ...
        Try
            ...
            If Me.rdoAllCustomers.Checked = True Then
                Me.CustReport.SearchingBy = WindowCustomerRpt.SearchBy.All
                Me.txtFirstName.Text = ""
                Me.txtLastName.Text = ""
            Else
                Me.CustReport.SearchingBy = WindowCustomerRpt.SearchBy.Name
            End If
    ...
    Private Sub OpenCustomer()
        ...
        If Me.ugCustomers.Rows.VisibleRowCount > 0 Then
            ...
            Utilities.ViewAddEditWindowCustomer(Me.ParentForm, CusObj, Me)
        End If
    ...
    Public Sub ReloadData()
        ...
        Me.CustReport.SetMasterDataSource()
        Me.ugCustomers.DataSource = Me.CustReport.DataView
        Me.Text = ("Search for Customers  (Window Customer Grand Total: " & Me.ugCustomers.Rows.Count.ToString & ")")
    ...
    Private Sub btnAddNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        Try
            Utilities.ViewAddEditWindowCustomer(Me.MdiParent, Nothing, Me)
    ...
    Private Sub ugCustomers_InitializeLayout(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs) Handles ugCustomers.InitializeLayout
        ...
        With e.Layout.Bands(0)
            ...
            .Columns(14).Header.Caption = "Price"
            .Columns(14).Format = "c"
        End With

        Me.Text = ("Window Customers  (Grand Total: " & Me.ugCustomers.Rows.Count.ToString & ")")
